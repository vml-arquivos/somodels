...
| Excluir | Faz exclusão lógica direta pelo painel autorizado, marca o registro como excluído, remove publicação e uploads novos, e preserva mídia, auditoria e referências para rastreabilidade. Não exige prompt, digitação de slug ou motivo obrigatório. | Sim, por restauração |
