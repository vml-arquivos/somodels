...
export default function LoginPage() {
  ...
  const login = trpc.auth.login.useMutation({
    onSuccess: ({ mustChangePassword }) => {
      ...
      navigate(mustChangePassword ? `/alterar-senha?returnTo=${encodeURIComponent(returnTo)}` : returnTo);
